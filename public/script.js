...
jQuery(async function () {
    ...
    $('#send_but, #option_regenerate, #option_continue, #mes_continue, #option_lookaround, #mes_impersonate').on('click', () => {
    ...
    $(document).click(event => {
        if ($(':focus').attr('id') !== 'send_textarea') {
            var validIDs = ['options_button', 'send_but', 'mes_impersonate', 'mes_continue', 'send_textarea', 'option_lookaround', 'option_regenerate', 'option_continue'];
