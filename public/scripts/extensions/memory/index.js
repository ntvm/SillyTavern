...
function setMemoryContext(value, saveToMessage, index = null) {
	...
	case "XML_hints":
		var context = getContext();
		setExtensionPrompt(MODULE_NAME, formatMemoryValue(value), extension_settings.memory.position, 1, extension_settings.memory.scan, extension_settings.memory.role);
		$('#memory_contents').val(value);
