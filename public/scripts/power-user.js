...
function switchHideChatAvatars() {
    ...
    power_user.hideChatAvatars_enabled = (((value === null) || value == false ) ? false : value == 'true');
    /*console.log(`
        localstorage value:${value},
...
async function loadPowerUserSettings(settings, data) {
    ...
    power_user.hideChatAvatars_enabled = hideChatAvatars === null ? true : hideChatAvatars == 'false';
