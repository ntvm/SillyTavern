...
SlashCommandParser.addCommandObject(SlashCommand.fromProps({
    name: 'lookaround',
    callback: lookChatCallback,
    aliases: ['look'],
    helpString: 'Look around, and behold beauty of this world.',
}));

SlashCommandParser.addCommandObject(SlashCommand.fromProps({
    name: 'UpdateST',
    callback: Getupdate,
    aliases: ['update','updatest'],
    helpString: 'pdate Silly Tavern.',
}));

SlashCommandParser.addCommandObject(SlashCommand.fromProps({
    name: 'RebootST	',
    callback: Getreboot,
    aliases: ['reboot','rebootst'],
    helpString: 'Reboot Silly Tavern',
}));

SlashCommandParser.addCommandObject(SlashCommand.fromProps({
    name: 'deswipize',
    callback: DeswipizeChat,
    aliases: ['help'],
    helpString: 'Create new chat without swipes.',
}));
