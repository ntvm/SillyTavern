...
Обновлена ветка Prompt manager, (Можно менять местами где конкретно находятся разные части промпта. Однако есть подвох Main NSFW jail не автоэкспортируюся)
