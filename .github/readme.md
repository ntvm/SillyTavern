...
Поддержка проксей для OAI Dall-e(после включения галочки "Use instead key", Нажать шестеренку, это запишит проксю и пароль для использования. После этого можно вернуть свой пресет для текствовых ответов.);
