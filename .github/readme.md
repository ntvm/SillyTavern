...
----------------------
О Промпт менеджере. Я не гаранитурю его работаспособность в текущем виде, однако, вполне вероятно как минимум попытаюсь починить если сообщите о проблеме
----------------------
Мини инструкция. 
