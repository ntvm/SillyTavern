...
const presetFolders = [DIRECTORIES.koboldAI_Settings, DIRECTORIES.openAI_Settings, DIRECTORIES.novelAI_Settings, DIRECTORIES.textGen_Settings, DIRECTORIES.NvSettings, DIRECTORIES.ProxyManager];
