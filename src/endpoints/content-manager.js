...
const presetFolders = [DIRECTORIES.koboldAI_Settings, DIRECTORIES.openAI_Settings, DIRECTORIES.novelAI_Settings, DIRECTORIES.textGen_Settings, DIRECTORIES.NvSettings, DIRECTORIES.ProxyManager, DIRECTORIES.quickreplies];
...
function getTargetByType(type) {
    switch (type) {
        ...
        case 'NvPresets':
            return DIRECTORIES.NvSettings;
        case 'ProxyManager':
            return DIRECTORIES.ProxyManager;
        case 'quickReplyPresets':
